  ...
  return (
    <section className='mt-6 mb-12 text-sm sm:flex sm:flex-row sm:items-center '>     
      <div className='sm:mb-0 mb-4 me-4'>
        ...
        <input className='rounded-md px-2 py-1 text-sm shadow-inner  shadow-stone-400 drop-shadow-md dark:text-white dark:bg-gray-600 dark:shadow-none dark:focus:bg-blue-950 focus:bg-blue-100 search-input'
          name='search'
          value={searchText}
